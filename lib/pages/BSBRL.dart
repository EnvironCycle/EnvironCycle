...
class BSB extends StatefulWidget {
  @override
  _BSBState createState() => _BSBState();
}
...
class _BSBState extends State<BSB> {

  Position _currentUserPosition;
  double distanceInMeters1 = 0.0;
  Future<double> _distanceConfirmed1;
  ...
  void initState() {
    super.initState();
    _distanceConfirmed1 = getTheDistance1();
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            Row(
              ...
              // First recycling location in brunei muara
            ...
            Row(
              ...
              Row(
               ...
               // Second recycling location in brunei muara
              ...
              Row(
                children: [
                  ...
                  Text('${snapshot.data[2]} Kilometers Away' ,
                       ...
                       // Third recycling location in brunei muara
